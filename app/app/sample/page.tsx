  ...
  competitors: [
    {
      name: "Cursor",
      signals: [
        { text: "Pricing page changed: Pro $20 → $60/mo", type: "alert" },
        { text: "67 open roles (+12 this week)", type: "alert" },
        { text: "Changelog updated Feb 11" },
      ],
    },
    {
      name: "GitHub Copilot",
      signals: [
        { text: "GPT-5.3-Codex now generally available", type: "new" },
        { text: "71.2M VS Code installs (+2.1M this month)" },
    ...
    },
    {
      name: "Codex (OpenAI)",
      signals: [
        { text: "Launched to public Feb 9", type: "new" },
        { text: "1M+ downloads in first week", type: "alert" },
        { text: "47 HN mentions this week" },
      ],
    },
    {
      name: "Windsurf",
      signals: [
        { text: "Tab v2 launched", type: "new" },
        { text: "Free tier expanded: 500 credits/mo" },
        { text: "52 open roles (+8 this week)" },
      ],
    },
    {
      name: "Claude Code",
      signals: [
        { text: "66K GitHub stars (+2.1K this week)" },
        { text: "v2.1.39 released" },
        { text: "23 HN mentions this week" },
      ],
    },
    {
      name: "Replit",
      signals: [
        { text: "New pricing tier: Starter $1/mo", type: "new" },
        { text: "34 open roles" },
      ],
    },
  ],
